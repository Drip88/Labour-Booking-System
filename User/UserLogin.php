...
<body >
  <div class="mb-3 mt-5 text-center text-success  font-weight-bold custom-body " style="font-size: 30px;">
  <i class="fas fa-user"></i>
      <span>Labour Booking System</span>

  </div> 
  <p class="text-center text-success font-weight-bold " style="font-size:25px;"> <i class="fas fa-user-secret text-success" ></i> User Login Page</p> 
    ...
    <div class="row justify-content-center mt-5">
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4 bg-light" method="POST">
          ...
          <div class="form-group">
            <i class="fas fa-key"></i> <label for="password" class="font-weight-bold pl-2">Password</label><input type="password" id  ="password" class="form-control" placeholder="Password" name="rPassword">
